    ...
    <header className="h-[88px] bg-white border border-slate-100 flex items-center justify-between px-8 sticky top-0 z-10">
      ...
      <div className="flex items-center gap-6">
        <Popover open={isNotificationOpen} onOpenChange={setIsNotificationOpen}>
          ...
          <PopoverContent className="w-[400px] p-0 bg-white rounded-2xl shadow-lg border border-slate-100" align="end">
            <motion.div
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: 10 }}
        ...
        <Popover open={isProfileOpen} onOpenChange={setIsProfileOpen}>
          ...
          <PopoverContent className="w-[300px] p-0 bg-white rounded-2xl shadow-lg border border-slate-100" align="end">
            <motion.div
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: 10 }}
