  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      ...
      <div className="flex-1">
        ...
        />
        <main className="p-8">
          <section className="grid grid-cols-4 gap-7 max-md:grid-cols-2 max-sm:grid-cols-1">
            <StatCard
              ...
              actionButton={
                <div className="flex items-center gap-2 bg-[#5BCFC5] px-3 py-2 rounded-lg">
          ...
          <section className="grid grid-cols-[1fr_359px] gap-6 mt-8 max-md:grid-cols-1">
            <AnalyticsChart />
            <Calendar />
          </section>
